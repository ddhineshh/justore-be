...
import { getProducts, getProductById, deleteProduct, updateProduct, createProduct, addProductReview, searchProducts, getTopProducts, getProductsByGenre,getProductsByCategory} from '../controllers/productController.js'
